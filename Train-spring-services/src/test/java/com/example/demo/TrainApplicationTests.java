...
class TrainApplicationTests {
	...
	public void getTrainTest() {
		when(trainrepository.findAll()).thenReturn(Stream
				.of(new Train("12","krishna express","secunderabad junction","basar"), new Train("12","Jagannath Express","pune","hyderbad")).collect(Collectors.toList()));
		assertEquals(2,trainService.getContact().size());
	}
		@Test
		public void saveTrainTest() {
			Train train = new Train("877","Sangahamithra express","ramagundam","ksr bangaluru junction");
		...
		public void deleteUserTest() {
			Train train = new Train("12","telengana express","hyd","peddapelli");
